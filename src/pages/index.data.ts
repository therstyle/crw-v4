...
import type { SectionBgVideoProps } from '../components/SectionBgVideo.svelte'
import type { SectionIntroProps } from '../components/SectionIntro.svelte'
import type { SectionResumeProps } from '../components/SectionResume.svelte'
import type { SectionPortfolioProps } from '../components/SectionPortfolio.svelte'
import type { SectionContactProps } from '../components/SectionContact.svelte'
...
export const video: SectionBgVideoProps = {
  src: '/video/intro-web.mp4',
  type: 'video/mp4',
}

export const intro: SectionIntroProps = {
  id: 'intro',
...
export const resume: SectionResumeProps = {
  id: 'resume',
  resume: {
    title: 'Resume',
    items: [
...
export const portfolio: SectionPortfolioProps = {
  id: 'portfolio',
  title: 'Portfolio',
  items: [
    {
...
export const contact: SectionContactProps = {
  id: 'contact',
  title: 'Contact',
  items: [
    {
